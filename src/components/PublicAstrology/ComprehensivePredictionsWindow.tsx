/**
 * Comprehensive Astrological Predictions Dedicated Window (Pop-out & Fullscreen Modal)
 * Displays verified birth details, ascendant & moon signs, mahadasha, and multi-timeframe
 * (Weekly, Monthly, Yearly) life forecasts with one-click export, print, and auto-dispense.
...
export const ComprehensivePredictionsWindow: React.FC<ComprehensivePredictionsWindowProps> = ({
  ...
  // Always compute predictions strictly in the active selectedLanguage
...
${t('auspiciousColorsLabel')}: ${currentPrediction.luckyElements.luckyColors.join(', ')}
${t('luckyNumbersLabel')}: ${currentPrediction.luckyElements.luckyNumbers.join(', ')}
${t('dailyVedicMantra')}: "${currentPrediction.luckyElements.mantraOrAffirmation}"`;
    ...
    if (popup) {
      popup.document.write(`
        ...
        <head>
          ...
          <style>
            body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: #0e0307; color: #f8fafc; margin: 0; padding: 24px; }
            .card { background: #16050b; border: 1px solid #450a0a; border-radius: 12px; padding: 20px; margin-bottom: 20px; }
            .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #450a0a; padding-bottom: 16px; margin-bottom: 20px; }
            ...
            .badge { display: inline-block; padding: 4px 8px; border-radius: 6px; font-size: 12px; font-weight: bold; background: #450a0a; color: #fdba74; }
            ...
            .btn { background: #dc2626; color: #fff; padding: 8px 16px; border-radius: 8px; border: none; font-weight: bold; cursor: pointer; }
        ...
        <body>
          ...
          <div class="grid-2">
            <div class="card">
              ...
              <div style="background:#1c060e; padding:10px; border-radius:6px; font-size:12px; color:#fed7aa;">
            ...
            <div class="card">
              ...
              <p style="color:#f43f5e; font-size:13px;"><strong>${t('planetaryCautions')}:</strong> ${currentPrediction.cautionActivities.join(', ')}</p>
            </div>
          </div>

          <div class="card">
            <h3>🔮 ${t('vedicRemediesAndMantra')}</h3>
            ...
            <p><strong>${t('lifeGemstone')}:</strong> ${getGemstoneName(primaryGemstone, selectedLanguage)}</p>
            <p><strong>${t('dailyVedicMantra')}:</strong> <em>"${currentPrediction.luckyElements.mantraOrAffirmation}"</em></p>
          </div>
        </body>
        </html>
      `);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md font-sans">
      <div
        className={`bg-[#0e0307] border border-red-900/60 rounded-3xl flex flex-col shadow-2xl overflow-hidden text-slate-100 transition-all duration-200 ${
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between px-6 py-4 border-b border-red-950/80 bg-[#120408] gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 bg-red-950 text-orange-300 border border-orange-600/50 rounded-md">
                  {t('dedicatedWindow')}
                </span>
              ...
              <h2 className="text-base sm:text-lg font-bold text-white mt-0.5 font-['Outfit',sans-serif]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 bg-[#1a060e] hover:bg-[#280814] text-slate-300 hover:text-white border border-red-950 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer"
              title={t('copyBtn')}
            >
            ...
            <button
              ...
              className="p-2 text-slate-400 hover:text-white hover:bg-[#1c060e] rounded-xl transition cursor-pointer"
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 text-slate-400 hover:text-white hover:bg-rose-950/80 hover:text-rose-300 rounded-xl transition cursor-pointer"
              title={t('closeBtn')}
            >
              <X className="w-5 h-5" />
            </button>
        ...
        {/* Window Body                                                               */}
        {/* ========================================================================= */}
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 bg-[#0e0307]">
          {/* Section 1: Complete Birth Detail Information Card */}
          <div className="bg-[#120408] border border-red-900/60 rounded-2xl p-5 shadow-xl space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-red-950/80 pb-3">
              <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              <div className="bg-[#16050b] p-3 rounded-xl border border-red-950/80">
              ...
              <div className="bg-[#16050b] p-3 rounded-xl border border-red-950/80">
                <span className="text-[10px] text-orange-400 block uppercase font-bold">{t('ascendant') || 'Ascendant'} (Lagna)</span>
            ...
            <div className="flex flex-wrap items-center justify-between text-[11px] bg-[#1a060e] border border-orange-600/30 rounded-xl px-4 py-2.5 gap-3 text-slate-300">
              <div className="flex items-center gap-2">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 bg-[#120408] border border-red-900/60 p-3 rounded-2xl shadow-xl">
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold text-slate-400 uppercase tracking-wider px-2">
                {t('predictionHorizon')}:
              </span>
              <div className="flex items-center bg-[#18050d] p-1 rounded-xl border border-red-950">
                <button
                  type="button"
          ...
          <div className="bg-gradient-to-r from-[#1c060e] via-[#120408] to-[#1a050d] border border-red-900/60 rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2 max-w-2xl">
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase font-bold tracking-wider px-2.5 py-0.5 bg-amber-400/10 text-amber-300 border border-amber-400/30 rounded-full">
            ...
            <div className="flex flex-col items-center justify-center bg-[#100307] border border-red-950 p-5 rounded-2xl text-center min-w-[160px] self-start md:self-center shadow-inner">
              ...
              <span className="text-[11px] text-amber-300/90 font-semibold mt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {/* 1. Career & Wealth */}
            <div className="bg-[#120408] border border-red-900/60 rounded-2xl p-5 shadow-xl space-y-4 hover:border-orange-500/40 transition flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-white font-['Outfit',sans-serif]">{t('careerAndMoney')}</h4>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="p-3 bg-[#1a060e] border border-orange-600/30 rounded-xl text-xs text-orange-200 mt-2">
                <span className="font-bold text-orange-300 block mb-0.5">{t('strategicAction')}:</span>
                {currentPrediction.careerAndMoney.actionableTip}
              </div>
            </div>

            {/* 2. Relationships & Family */}
            <div className="bg-[#120408] border border-red-900/60 rounded-2xl p-5 shadow-xl space-y-4 hover:border-rose-500/40 transition flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 bg-[#1c060e] border border-rose-600/40 rounded-xl text-rose-400">
                      <Heart className="w-5 h-5" />
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-white font-['Outfit',sans-serif]">{t('loveAndFamily')}</h4>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="p-3 bg-[#1a060e] border border-rose-600/30 rounded-xl text-xs text-rose-200 mt-2">
            ...
            {/* 3. Health & Vitality */}
            <div className="bg-[#120408] border border-red-900/60 rounded-2xl p-5 shadow-xl space-y-4 hover:border-emerald-500/40 transition flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 bg-[#1c060e] border border-emerald-600/40 rounded-xl text-emerald-400">
                      <Activity className="w-5 h-5" />
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-white font-['Outfit',sans-serif]">{t('healthAndVitality')}</h4>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="p-3 bg-[#1a060e] border border-emerald-600/30 rounded-xl text-xs text-emerald-200 mt-2">
                <span className="font-bold text-emerald-300 block mb-0.5">{t('vitalityDirective')}:</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="bg-[#120408] border border-emerald-700/50 rounded-2xl p-5 shadow-xl space-y-3">
              <div className="flex items-center gap-2 text-emerald-400 font-['Outfit',sans-serif]">
            ...
            <div className="bg-[#120408] border border-rose-800/50 rounded-2xl p-5 shadow-xl space-y-3">
              <div className="flex items-center gap-2 text-rose-400 font-['Outfit',sans-serif]">
          ...
          <div className="bg-[#120408] border border-red-900/60 rounded-2xl p-6 shadow-xl space-y-5">
            <div className="flex items-center gap-2 border-b border-red-950/80 pb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-3.5 bg-[#16050b] rounded-xl border border-red-950/80">
              ...
              <div className="p-3.5 bg-[#16050b] rounded-xl border border-red-950/80">
                <span className="text-[10px] text-orange-400 uppercase font-bold block mb-1">{t('auspiciousColorsLabel')}</span>
            ...
            <div className="p-4 bg-[#1a060e] border border-orange-600/30 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="space-y-1">
                <div className="text-[10px] uppercase font-bold text-orange-300">
                  {t('dailyVedicMantra')}
                </div>
                <div className="text-xs sm:text-sm font-medium text-orange-100 italic">
              ...
              {chartData.interpretations?.gemstoneRecommendations?.[0] && onAutoDispenseGemstone && (
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 shadow-md transition cursor-pointer whitespace-nowrap"
                >
        ...
        {/* Footer Bar                                                                */}
        {/* ========================================================================= */}
        <div className="flex flex-wrap items-center justify-between px-6 py-3 border-t border-red-950/80 bg-[#120408] text-xs text-slate-400">
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-1.5 bg-[#1c060e] hover:bg-[#280814] text-white border border-red-950 rounded-lg font-bold cursor-pointer transition"
            >
              {t('closeBtn')}
            </button>
          </div>
